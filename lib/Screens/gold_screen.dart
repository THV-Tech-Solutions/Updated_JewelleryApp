...
class _GoldScreenState extends State<GoldScreen> {
  ...
  void initState() {
    super.initState();
    assert(titles.length == categoriesForTitles.length,
        'Error: titles and categoriesForTitles must have the same length');
          ...
          return Container(
            ...
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                return const SizedBox.shrink(); // Handle out-of-bound access
              },
            ),
          );
        },
